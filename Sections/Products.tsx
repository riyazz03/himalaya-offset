        ...
        <div className="products-wrapper">
          <div className='product-left'>
            <div className='product-left-top'>
              ...
              <h2 className='section-title'>Top <span>Selling Products</span></h2>
            </div>
            <div className='product-left-bottom'>
              <Link href="/products" className='product-left-bottom-card'>
                <h3 className='product-left-bottom-card-title'>Explore All Products</h3>
